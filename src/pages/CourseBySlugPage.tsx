    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-2 md:space-y-0">
            ...
            <nav className="flex items-center space-x-4 md:space-x-6 text-sm md:text-base">
              {isAuthenticated ? (
                ...
                <>
                  <Link to="/login" className="text-gray-700 hover:text-[#FF6600]">Entrar</Link>
                  <Link to="/register" className="bg-[#FF6600] text-white px-4 py-2 rounded-md font-semibold hover:bg-[#e55a00] transition-colors">
                    Cadastrar
                  </Link>
                </>
              )}
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-4 md:py-6">
          <Link to="/" className="text-[#FF6600] hover:underline mb-4 inline-block">
            ← Voltar para Início
          </Link>
